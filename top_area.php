	...
	<div class="container">
		<div class="top-area-items inline-inside">
			<?php if(thegem_get_option('top_area_contacts')) : ?>
				<a href="https://webcb.rivernetworks.com/click-to-dial/CX2HihDG" title="Click to Schedule a call back with one of our friendly sales representatives." alt="" target="_blank">
				<div class="top-area-block top-area-contacts"><?php echo thegem_top_area_contacts(); ?>
				</a></div>
			<?php endif; ?>
